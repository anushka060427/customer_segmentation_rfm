...
This project applies RFM (Recency, Frequency, Monetary) analysis and K-Means clustering to segment customers into distinct groups based on their transactional behavior.
Clusters : 
...
2. RFM Analysis: Calculated Recency, Frequency, and Monetary scores for each customer
...
- Python
- Pandas, NumPy, and Scikit-learn libraries for EDA and model preparation. 
